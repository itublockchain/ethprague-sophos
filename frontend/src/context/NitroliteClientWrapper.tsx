    ...
    try {
      ...
      const stateWalletClient = {
        ...
        signMessage: async ({
          ...
          const { serialized: signature } = wallet.signingKey.sign(
            raw as ethers.BytesLike
          );
      ...
      try {
        ...
        if (!(window as any).ethereum) {
          setClientState((prev) => ({
            ...
            loading: false,
            error:
              "MetaMask provider not found. Please refresh the page or reinstall MetaMask.",
          }));
          return;
        }
        ...
        console.log(
          "Wallet client created successfully:",
        ...
        if (error instanceof Error) {
          if (error.message.includes("provider")) {
            errorMessage =
              "MetaMask provider error. Please refresh the page and try again.";
          } else if (error.message.includes("wallet")) {
            errorMessage =
              "Wallet client creation failed. Please ensure MetaMask is connected properly.";
          } else {
